...
/*   Updated: 2023/01/04 17:46:46 by rteles-f         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// for (int i = 0; vmap->map[i]; i++)
// 	printf("%s", vmap->map[i]);
// printf("\ncollecs: %i, %i / %i", vmap->collectables[0], 
//vmap->collectables[1], (!!vmap->map));
...
the length/height of the matrix.
*/
